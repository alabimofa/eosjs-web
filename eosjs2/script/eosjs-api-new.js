var eosjs_api = function(e) {
    ...
    11: function(e, t, r) {
        ...
        var o = r(12).RIPEMD160.hash
          , s = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"
          , u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
        var c = function() {
            for (var e = Array(256).fill(-1), t = 0; t < s.length; ++t)
                e[s.charCodeAt(t)] = t;
            return e
        }();
        var l = function() {
        ...
        function y(e, t) {
            ...
            for (var r = Array(t).fill("0".charCodeAt(0)), n = e.length - 1; n >= 0; --n) {
                for (var a = e[n], o = 0; o < r.length; ++o) {
                    var s = (r[o] - "0".charCodeAt(0) << 8) + a;
                    r[o] = "0".charCodeAt(0) + s % 10,
                    a = s / 10 | 0
                }
                for (; a; )
                    r.push("0".charCodeAt(0) + a % 10),
                    a = a / 10 | 0
            }
            return r.reverse(),
            String.fromCharCode.apply(String, i(r))
        }
        function d(e, t) {
            for (var r = new Uint8Array(e), n = 0; n < t.length; ++n) {
                var i = c[t.charCodeAt(n)];
                if (i < 0)
        ...
        function g(e, t) {
            ...
            try {
                for (var f = a(e), h = f.next(); !h.done; h = f.next()) {
                    for (var p = h.value, y = 0; y < l.length; ++y) {
                        var d = (c[l[y]] << 8) + p;
                        l[y] = s.charCodeAt(d % 58),
                        p = d / 58 | 0
                    }
                    for (; p; )
                        l.push(s.charCodeAt(p % 58)),
                        p = p / 58 | 0
                }
            } catch (e) {
                r = {
            ...
            try {
                for (var g = a(e), m = g.next(); !m.done; m = g.next()) {
                    if (m.value)
                        break;
            ...
            return l.reverse(),
            String.fromCharCode.apply(String, i(l))
        }
        function m(e, t) {
            for (var r = new Uint8Array(e.length + t.length), n = 0; n < e.length; ++n)
                r[n] = e[n];
            for (n = 0; n < t.length; ++n)
                r[e.length + n] = t.charCodeAt(n);
            return o(r)
        }
        function v(e, t, r, n) {
            var i = d(r + 4, e)
            ...
            if (o[0] !== i[r + 0] || o[1] !== i[r + 1] || o[2] !== i[r + 2] || o[3] !== i[r + 3])
                throw new Error("checksum doesn't match");
            return a
        }
        function b(e, t, r) {
            for (var n = new Uint8Array(m(e.data, t)), i = new Uint8Array(e.data.length + 4), a = 0; a < e.data.length; ++a)
                i[a] = e.data[a];
            for (a = 0; a < 4; ++a)
                i[a + e.data.length] = n[a];
            return r + g(i)
        }
        function w(e) {
            if ("string" != typeof e)
            ...
            if ("EOS" === e.substr(0, 3)) {
                for (var r = d(t.publicKeyDataSize + 4, e.substr(3)), n = {
                    type: 0,
                    data: new Uint8Array(t.publicKeyDataSize)
                }, i = 0; i < t.publicKeyDataSize; ++i)
                    n.data[i] = r[i];
                var a = new Uint8Array(o(n.data));
                if (a[0] !== r[t.publicKeyDataSize] || a[1] !== r[34] || a[2] !== r[35] || a[3] !== r[36])
                    throw new Error("checksum doesn't match");
                return n
            }
            if ("PUB_K1_" === e.substr(0, 7))
                return v(e.substr(7), 0, t.publicKeyDataSize, "K1");
            if ("PUB_R1_" === e.substr(0, 7))
                return v(e.substr(7), 1, t.publicKeyDataSize, "R1");
            throw new Error("unrecognized public key format")
        }
        function _(e) {
            if (0 === e.type && e.data.length === t.publicKeyDataSize)
                return b(e, "K1", "PUB_K1_");
            if (1 === e.type && e.data.length === t.publicKeyDataSize)
                return b(e, "R1", "PUB_R1_");
            throw new Error("unrecognized public key format")
        }
        function A(e) {
            return "EOS" === e.substr(0, 3) ? _(w(e)) : e
        }
        t.isNegative = f,
        t.negate = h,
        t.decimalToBinary = p,
        t.signedDecimalToBinary = function(e, t) {
            var r = "-" === t[0];
            r && (t = t.substr(1));
            var n = p(e, t);
            if (r) {
        ...
        ,
        t.binaryToDecimal = y,
        t.signedBinaryToDecimal = function(e, t) {
            if (void 0 === t && (t = 1),
            f(e)) {
                var r = e.slice();
                return h(r),
        ...
        t.base64ToBinary = function(e) {
            ...
            for (var i = new Uint8Array(n), a = 0; a < r; ++a) {
                var o = l[e.charCodeAt(4 * a + 0)]
                  , s = l[e.charCodeAt(4 * a + 1)]
                  , u = l[e.charCodeAt(4 * a + 2)]
                  , c = l[e.charCodeAt(4 * a + 3)];
                i[3 * a + 0] = o << 2 | s >> 4,
                3 * a + 1 < n && (i[3 * a + 1] = (15 & s) << 4 | u >> 2),
        ...
        t.stringToPublicKey = w,
        t.publicKeyToString = _,
        t.convertLegacyPublicKey = A,
        ...
        t.stringToPrivateKey = function(e) {
            ...
            if ("PVT_R1_" === e.substr(0, 7))
                return v(e.substr(7), 1, t.privateKeyDataSize, "R1");
            throw new Error("unrecognized private key format")
        }
        ,
        t.privateKeyToString = function(e) {
            if (1 === e.type)
                return b(e, "R1", "PVT_R1_");
            throw new Error("unrecognized private key format")
        }
        ,
        t.stringToSignature = function(e) {
            ...
            if ("SIG_K1_" === e.substr(0, 7))
                return v(e.substr(7), 0, t.signatureDataSize, "K1");
            if ("SIG_R1_" === e.substr(0, 7))
                return v(e.substr(7), 1, t.signatureDataSize, "R1");
            throw new Error("unrecognized signature format")
        }
        ,
        t.signatureToString = function(e) {
            if (0 === e.type)
                return b(e, "K1", "SIG_K1_");
            if (1 === e.type)
                return b(e, "R1", "SIG_R1_");
            throw new Error("unrecognized signature format")
        }
    },
    12: function(e, t, r) {
        ...
        class n {
            constructor() {}
            static get_n_pad_bytes(e) {
                return 64 - (e + 8 & 63)
            }
            static pad(e) {
                const t = e.byteLength
                  , r = n.get_n_pad_bytes(t)
                  , [i,a] = ((e,t)=>[Math.floor(e / t), e % t])(t, 536870912).map((e,t)=>t ? 8 * e : e)
                  , o = new Uint8Array(t + r + 8);
                o.set(new Uint8Array(e), 0);
                const s = new DataView(o.buffer);
                return s.setUint8(t, 128),
                s.setUint32(t + r, a, !0),
                s.setUint32(t + r + 4, i, !0),
                o.buffer
            }
            static f(e, t, r, n) {
            ...
            static add_modulo32() {
                return 0 | Array.from(arguments).reduce((e,t)=>e + t, 0)
            }
            static rol32(e, t) {
                return e << t | e >>> 32 - t
            }
            static hash(e) {
                const t = n.pad(e)
                  ...
                  , s = t.byteLength / 64
                  , u = new Array(s).fill(void 0).map((e,r)=>e=>new DataView(t,64 * r,64).getUint32(4 * e, !0));
                let c = [1732584193, 4023233417, 2562383102, 271733878, 3285377520];
                for (let e = 0; e < s; ++e) {
                    let t = c[0]
                      , s = c[1]
                      , l = c[2]
                      ...
                      , m = h;
                    for (let c = 0; c < 80; ++c) {
                        let v = n.add_modulo32(n.rol32(n.add_modulo32(t, n.f(c, s, l, f), u[e](r[c]), n.K(c)), a[c]), h);
                        t = h,
                        h = f,
                        f = n.rol32(l, 10),
                        l = s,
                        s = v,
                        v = n.add_modulo32(n.rol32(n.add_modulo32(p, n.f(79 - c, y, d, g), u[e](i[c]), n.KP(c)), o[c]), m),
                        p = m,
                        m = g,
                        g = n.rol32(d, 10),
                        d = y,
                    ...
                    let v = n.add_modulo32(c[1], l, g);
                    c[1] = n.add_modulo32(c[2], f, m),
                    c[2] = n.add_modulo32(c[3], h, p),
                    c[3] = n.add_modulo32(c[4], t, y),
                    c[4] = n.add_modulo32(c[0], s, d),
                    c[0] = v
                }
                const l = new ArrayBuffer(20)
                  , f = new DataView(l);
                return c.forEach((e,t)=>f.setUint32(4 * t, e, !0)),
                l
            }
        }
        e.exports = {
        ...
        var l = r(54)
          ...
          , p = function() {
            function e(e) {
                ...
                this.transactionTypes = l.getTypesFromAbi(l.createInitialTypes(), h)
            }
            return e.prototype.rawAbiToJson = function(e) {
                ...
                return t.restartRead(),
                this.abiTypes.get("abi_def").deserialize(t)
            }
            ,
                ...
                i(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        ...
                        case 2:
                            ...
                            [3, 4];
                        case 3:
                            throw (o = a.sent()).message = "fetching abi for " + e + ": " + o.message,
                            o;
                        case 4:
                            if (!r)
                                throw new Error("Missing abi for " + e);
                            return this.cachedAbis.set(e, r),
                            [2, r]
                        }
                    })
                })
            ...
            e.prototype.getContract = function(e, t) {
                ...
                i(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        ...
                        case 1:
                            i = a.sent(),
                            o = l.getTypesFromAbi(l.createInitialTypes(), i),
                            s = new Map;
                            try {
                                for (u = c(i.actions),
            ...
            e.prototype.deserializeTransaction = function(e) {
                ...
                return t.pushArray(e),
                this.deserialize(t, "transaction")
            }
            ,
                            ...
                            return [4, Promise.all(e.map(function(e) {
                                ...
                                return i(t, void 0, void 0, function() {
                                    ...
                                    return a(this, function(t) {
                                        ...
                                        case 1:
                                            return e = t.sent(),
                                            [2, l.serializeAction(e, r, n, o, s, this.textEncoder, this.textDecoder)]
                                        }
                                    })
                                })
                            }))];
                            ...
                            return [4, Promise.all(e.map(function(e) {
                                ...
                                return i(t, void 0, void 0, function() {
                                    ...
                                    return a(this, function(t) {
                                        ...
                                        case 1:
                                            return e = t.sent(),
                                            [2, l.deserializeAction(e, r, n, o, s, this.textEncoder, this.textDecoder)]
                                        }
                                    })
                                })
                            }))];
            ...
            e.prototype.deserializeTransactionWithActions = function(e) {
                return i(this, void 0, void 0, function() {
                    ...
                    return a(this, function(i) {
                        switch (i.label) {
                        case 0:
                            return "string" == typeof e && (e = l.hexToUint8Array(e)),
                            t = this.deserializeTransaction(e),
                            [4, this.deserializeActions(t.actions)];
                        case 1:
                            return r = i.sent(),
                            [2, n({}, t, {
                                actions: r
            ...
            e.prototype.transact = function(e, t) {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        ...
                        case 1:
                            t = a.sent(),
                            this.chainId = t.chain_id,
                            a.label = 2;
                        case 2:
                            return "number" == typeof f && h ? t ? [3, 4] : [4, this.rpc.get_info()] : [3, 6];
                        case 3:
                            t = a.sent(),
                            a.label = 4;
                        case 4:
                            return [4, this.rpc.get_block(t.head_block_num - f)];
                        case 5:
                            r = a.sent(),
                            e = n({}, l.transactionHeader(r, h), e),
                            a.label = 6;
                        case 6:
                        ...
                        case 8:
                            return e = n.apply(void 0, o.concat([(u.actions = a.sent(), u)])),
                            p = this.serializeTransaction(e),
                            m = this.serializeContextFreeData(t.context_free_data),
                            y = {
                                serializedTransaction: p,
                                serializedContextFreeData: m,
                                signatures: []
                            },
                            c ? [4, this.signatureProvider.getAvailableKeys()] : [3, 12];
                        case 9:
                            return d = a.sent(),
                            [4, this.authorityProvider.getRequiredKeys({
                                transaction: e,
                                availableKeys: d
                            })];
                        case 10:
                            return g = a.sent(),
                            [4, this.signatureProvider.sign({
                        ...
                        case 11:
                            ...
                            a.label = 12;
                        case 12:
                            return s ? [2, this.pushSignedTransaction(y)] : [2, y]
                        }
                    })
                })
            }
    ...
    54: function(e, t, r) {
        ...
        var c = function() {
            function e(e) {
                ...
                this.textDecoder = n || new TextDecoder("utf-8",{
                    fatal: !0
                })
            }
            ...
            e.prototype.pushName = function(e) {
                ...
                for (var r = new Uint8Array(8), n = 63, i = 0; i < e.length; ++i) {
                    ...
                    n < 5 && (a <<= 1);
                    for (var o = 4; o >= 0; --o)
                        n >= 0 && (r[Math.floor(n / 8)] |= (a >> o & 1) << n % 8,
                        --n)
                }
                this.pushArray(r)
            }
            ...
            e.prototype.getName = function() {
                for (var e = this.getUint8Array(8), t = "", r = 63; r >= 0; ) {
                    for (var n = 0, i = 0; i < 5; ++i)
                        r >= 0 && (n = n << 1 | e[Math.floor(r / 8)] >> r % 8 & 1,
                        --r);
            ...
            e.prototype.pushSymbolCode = function(e) {
                ...
                var t = [];
                for (t.push.apply(t, a(this.textEncoder.encode(e))); t.length < 8; )
                    t.push(0);
            ...
            e.prototype.pushSymbol = function(e) {
                var t = e.name
                  , r = [255 & e.precision];
                for (r.push.apply(r, a(this.textEncoder.encode(t))); r.length < 8; )
                    r.push(0);
                this.pushArray(r.slice(0, 8))
            }
            ,
            e.prototype.getSymbol = function() {
                var e, t = this.get(), r = this.getUint8Array(7);
            ...
            e.prototype.pushAsset = function(e) {
                ...
                "-" === (e = e.trim())[t] && (r += "-",
                ++t);
                for (var i = !1; t < e.length && e.charCodeAt(t) >= "0".charCodeAt(0) && e.charCodeAt(t) <= "9".charCodeAt(0); )
                    i = !0,
                    r += e[t],
                    ++t;
                if (!i)
                ...
                if ("." === e[t])
                    for (++t; t < e.length && e.charCodeAt(t) >= "0".charCodeAt(0) && e.charCodeAt(t) <= "9".charCodeAt(0); )
                        r += e[t],
                        ++n,
                        ++t;
            ...
            e.prototype.getAsset = function() {
                var e = this.getUint8Array(8)
                  ...
                  , r = t.name
                  , n = t.precision
                  , i = s.signedBinaryToDecimal(e, n + 1);
                return n && (i = i.substr(0, i.length - n) + "." + i.substr(i.length - n)),
                i + " " + r
            }
            ,
            e.prototype.pushPublicKey = function(e) {
                var t = s.stringToPublicKey(e);
                this.push(t.type),
                this.pushArray(t.data)
            }
            ,
            e.prototype.getPublicKey = function() {
                var e = this.get()
                  , t = this.getUint8Array(s.publicKeyDataSize);
            ...
            e.prototype.getPrivateKey = function() {
                var e = this.get()
                  , t = this.getUint8Array(s.privateKeyDataSize);
            ...
            e.prototype.getSignature = function() {
                var e = this.get()
                  , t = this.getUint8Array(s.signatureDataSize);
        ...
        function z(e, t, r, n) {
            ...
            void 0 === n && (n = !0),
            "object" != typeof t)
                throw new Error("expected object containing data: " + JSON.stringify(t));
                ...
                for (var s = o(this.fields), c = s.next(); !c.done; c = s.next()) {
                    ...
                    if (l.name in t) {
                        ...
                        if (!n || !l.type.extensionOf)
                            throw new Error("missing " + this.name + "." + l.name + " (type=" + l.type.name + ")");
        ...
        function S(e, t, r, n) {
            ...
            e.pushVaruint32(i),
            this.fields[i].type.serialize(e, t[1], r, n)
        }
        function U(e, t, r) {
        ...
        function E(e, t, r, n) {
            ...
            try {
                for (var s = o(t), u = s.next(); !u.done; u = s.next()) {
                    var c = u.value;
        ...
        function D(e, t, r, n) {
            null === t || void 0 === t ? e.push(0) : (e.push(1),
            this.optionalOf.serialize(e, t, r, n))
        }
        function P(e, t, r) {
        ...
        function K(e, t) {
            if (Number.isNaN(+e) || Number.isNaN(+t) || "number" != typeof e && "string" != typeof e)
        ...
        function B(e, t) {
            ...
            if (t.endsWith("[]"))
                return O({
                    name: t,
                    arrayOf: B(e, t.substr(0, t.length - 2)),
                    serialize: E,
                    deserialize: T
                });
            if (t.endsWith("?"))
                return O({
                    name: t,
                    optionalOf: B(e, t.substr(0, t.length - 1)),
                    serialize: D,
                    deserialize: P
                });
            if (t.endsWith("$"))
                return O({
                    name: t,
                    extensionOf: B(e, t.substr(0, t.length - 1)),
                    serialize: C,
                    deserialize: k
                });
        ...
        function N(e, t, r, n, i, a) {
            ...
            if (!o)
                throw new Error("Unknown action " + r + " in contract " + t);
            var s = new c({
                textEncoder: i,
                textDecoder: a
            });
            return o.serialize(s, n),
            b(s.asUint8Array())
        }
        function R(e, t, r, n, i, a) {
            var o = e.actions.get(r);
            if ("string" == typeof n && (n = w(n)),
            !o)
                throw new Error("Unknown action " + r + " in contract " + t);
            var s = new c({
                textDecoder: a,
        ...
        t.dateToTimePoint = f,
        t.timePointToDate = h,
        t.dateToTimePointSec = p,
        t.timePointSecToDate = y,
        t.dateToBlockTimestamp = d,
        t.blockTimestampToDate = g,
        t.stringToSymbol = m,
        t.symbolToString = v,
        t.arrayToHex = b,
        t.hexToUint8Array = w,
        t.createInitialTypes = function() {
            var e = new Map(Object.entries({
                ...
                uint64: O({
                    name: "uint64",
                    serialize: function(e, t) {
                        e.pushArray(s.decimalToBinary(8, "" + t))
                    },
                    deserialize: function(e) {
                        return s.binaryToDecimal(e.getUint8Array(8))
                    }
                }),
                int64: O({
                    name: "int64",
                    serialize: function(e, t) {
                        e.pushArray(s.signedDecimalToBinary(8, "" + t))
                    },
                    deserialize: function(e) {
                        return s.signedBinaryToDecimal(e.getUint8Array(8))
                    }
                }),
                int32: O({
                    name: "int32",
                    serialize: function(e, t) {
                        e.pushUint32(K(t, 0 | t))
                    },
                    deserialize: function(e) {
                ...
                uint128: O({
                    name: "uint128",
                    serialize: function(e, t) {
                        e.pushArray(s.decimalToBinary(16, "" + t))
                    },
                    deserialize: function(e) {
                        return s.binaryToDecimal(e.getUint8Array(16))
                    }
                }),
                int128: O({
                    name: "int128",
                    serialize: function(e, t) {
                        e.pushArray(s.signedDecimalToBinary(16, "" + t))
                    },
                    deserialize: function(e) {
                        return s.signedBinaryToDecimal(e.getUint8Array(16))
                    }
                }),
                float32: O({
                    name: "float32",
                ...
                bytes: O({
                    ...
                    deserialize: function(e, t) {
                        return t.options.bytesAsUint8Array ? e.getBytes() : b(e.getBytes())
                    }
                }),
                string: O({
                    name: "string",
                ...
                time_point: O({
                    name: "time_point",
                    serialize: function(e, t) {
                        e.pushNumberAsUint64(f(t))
                    },
                    deserialize: function(e) {
                        return h(e.getUint64AsNumber())
                    }
                }),
                time_point_sec: O({
                    name: "time_point_sec",
                    ...
                    deserialize: function(e) {
                        return y(e.getUint32())
                    }
                }),
                block_timestamp_type: O({
                    name: "block_timestamp_type",
                    serialize: function(e, t) {
                        e.pushUint32(d(t))
                    },
                    deserialize: function(e) {
                        return g(e.getUint32())
                    }
                }),
                symbol_code: O({
                    name: "symbol_code",
        ...
        ,
        t.getType = B,
        t.getTypesFromAbi = function(e, t) {
            var r, n, a, s, u, c, l, f, h, p, y = new Map(e);
            if (t.types)
                try {
                    for (var d = o(t.types), g = d.next(); !g.done; g = d.next()) {
                        var m = g.value
                          , v = m.new_type_name
                          , b = m.type;
                        y.set(v, O({
            ...
            if (t.variants)
                try {
                    for (var P = o(t.variants), C = P.next(); !C.done; C = P.next()) {
                        var k = C.value
                          , K = k.name
                          , N = k.types;
                        y.set(K, O({
            ...
            try {
                for (var R = o(y), M = R.next(); !M.done; M = R.next()) {
                    var V = i(M.value, 2);
                    V[0],
                    (b = V[1]).baseName && (b.base = B(y, b.baseName));
                    try {
                        for (var I = o(b.fields), j = I.next(); !j.done; j = I.next()) {
                            var F = j.value;
                            F.type = B(y, F.typeName)
                        }
                    } catch (e) {
                        h = {
                            error: e
        ...
        t.transactionHeader = function(e, t) {
            return {
                expiration: y(p(e.timestamp) + t),
                ref_block_num: 65535 & e.block_num,
                ref_block_prefix: e.ref_block_prefix
            }
        }
        ,
        t.serializeActionData = N,
        t.serializeAction = function(e, t, r, n, i, a, o) {
            return {
                account: t,
                name: r,
                authorization: n,
        ...
        ,
        t.deserializeActionData = R,
        t.deserializeAction = function(e, t, r, n, i, a, o) {
            return {
                account: t,
                name: r,
                authorization: n,
